                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h6>
                            ...
                            <small class="mt-2 text-muted">({{AuthRole()}})</small>
                        </h6>
            ...
            <div class="col-lg-9 col-md-7">
                ...
                <div class="card">
                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                        <li class="nav-item " >
                            <a class="nav-link active" id="pills-activity-tab" data-toggle="pill" href="#profile-tab" role="tab" aria-controls="pills-activity" aria-selected="true">{{ __('Profile')}}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " id="pills-password-tab" data-toggle="pill" href="#password-tab" role="tab" aria-controls="pills-password" aria-selected="false">{{ __('Change Password')}}</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="profile-tab" role="tabpanel" aria-labelledby="pills-setting-tab">
                            @include('user.includes.details')
                        </div>
                        <div class="tab-pane fade" id="password-tab" role="tabpanel" aria-labelledby="pills-setting-tab">
                ...
                <div class="modal fade" id="updateProfileImageModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="updateProfileImageModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <form action="{{ route('panel.update-profile-img', $user->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return checkCoords();">
