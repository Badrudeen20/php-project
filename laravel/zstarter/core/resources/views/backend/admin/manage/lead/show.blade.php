            ...
            <div class="col-md-12 mx-auto">
                <div class="card ">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="">
                            <div class="dropdown">
                                <div class="badge badge-warning mr-2" name="status">{{fetchFirst('App\Models\Category',$lead->lead_type_id,'name','--') }}</div>
                            ...
                            {{-- <div class="card"> --}}
                                <div class="card-body pb-0">
                                    <div class="text-center"> 
                                        <div style="width: 80px; height: 80px; position: relative" class="">
                                        ...
                                        <h4 class="card-title"style="margin: 75px 0px 0px 35px;">{{$lead->name}}</h4>
                                        <h6 class="mt-10" style="margin-left:35px;">{{NameById($lead->user_id)}}</h6>
                                    </div>
                                </div>
                                <hr class="mb-0"> 
                                <div class="card-body"> 
                                    ...
                                    <small class="text-muted d-block pt-10">{{ __('Lead Source')}}</small>
