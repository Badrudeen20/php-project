                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 {{ $errors->has('owner_email') ? 'has-error' : ''}}">
                                                    ...
                                                    <input class="form-control" name="owner_email" type="email" id="owner_email" placeholder="Enter Owner Email" value="{{ isset($lead->owner_email) ? $lead->owner_email : ''}}">
                                                </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <div class="form-radio" style="height: 200px;overflow-y: auto;">
                                                    @foreach (fetchGet('App\Models\Category', 'where', 'category_type_id', '=', 5) as $item)
                                                        <div class="radio">
                                                            <label>
                                                                <input type="radio"  name="lead_source_id" value="{{ $item->id }}" {{ $lead->lead_source_id  == $item->id ? 'checked' :'' }} required>
