                ...
                <div class="card ">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="last-month" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <div class="card-body">
                                <div class="">
                                    <p class="mb-0"><strong>Hey, your enquiry is here:</strong> Name: {{ NameById($support_ticket->user_id) }}, Subject: {{ $support_ticket->subject ?? "N\A" }}, Message: {{ Str::limit($support_ticket->message,70) }},<br>
                                        <small  class="text-muted"> {{ getFormattedDate($support_ticket->created_at) }}</small></p>
                        ...
                        <div class="tab-pane fade" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
                            <div class="card-body">
                                <form action="{{route('panel.constant_management.support_ticket.add-attachment',$support_ticket->id)}}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="d-flex">
                                        <input type="file" class="form-control" style="width:100%; margin-bottom:15px;" name="file_name"required>
...
{{-- <script>
    $('#attachment_update').on('click',function(){
        $('#form_sub').submit();
    });
</script> --}}
