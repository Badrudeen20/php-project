        ...
        <div class="d-flex justify-content-between mb-2">
            ...
            <div>
                ...
                <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                    ...
                    <li class="dropdown-item p-0 col-btn" data-val="col_1"><a href="javascript:void(0);"  class="btn btn-sm">User  </a></li>                    <li class="dropdown-item p-0 col-btn" data-val="col_2"><a href="javascript:void(0);"  class="btn btn-sm">Amount</a></li>                    <li class="dropdown-item p-0 col-btn" data-val="col_3"><a href="javascript:void(0);"  class="btn btn-sm">Type</a></li>                    <li class="dropdown-item p-0 col-btn" data-val="col_4"><a href="javascript:void(0);"  class="btn btn-sm">Status</a></li>                    <li class="dropdown-item p-0 col-btn" data-val="col_5"><a href="javascript:void(0);"  class="btn btn-sm">Approved By</a></li>                    <li class="dropdown-item p-0 col-btn" data-val="col_6"><a href="javascript:void(0);"  class="btn btn-sm">Approved At</a></li>                                        
                </ul>
                        ...
                        @foreach($payouts as  $payout)
                            <tr>
                                ...
                                <td  class="text-center"><a style="" class="text-primary" href="{{ route('panel.payouts.show', $payout->id) }}">#POUT{{  getPrefixZeros($payout->id) }}</a></td>
                                    <td class="col_1">{{fetchFirst('App\User',$payout->user_id,'first_name','--')}}</td>
                                  ...
                                  <td class="col_6">{{ getFormattedDate($payout->created__at) }}</td>
