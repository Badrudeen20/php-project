...
Route::group(['middleware' => 'auth','prefix' => 'panel', 'as' => 'panel.'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::post('/user/update-password/{id}', [UserController::class, 'updateUserPassword'])->name('update-user-password');
    ...
    Route::group(['namespace' => 'Admin\ConstantManagement','middleware' => 'can:manage_setting', 'prefix' => '', 'as' => 'constant_management.'], function () {
        ...
        function () {
            ...
            Route::post('/add-attachment/{id}', [SupportTicketController::class,'addAttachment'])->name('add-attachment');
